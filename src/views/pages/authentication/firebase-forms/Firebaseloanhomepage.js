...
import FirebaseModalDigitalAssetTAC from '../LoanApplicationModule/FirebaseModalDigitalAssetTAC';
...
const Firebaseloanhomepage = (props, { ...others }) => {
                    ...
                    style={{ marginTop: "-20px", marginBottom: "13px" }}>
                        ...
                        <Box m="auto">
                            <Stack alignItems="row" justifyContent="left" spacing={1}>
                                ...
                                <Avatar sx={{ height: '30px', width: '200px', backgroundColor: 'white' }} variant="rounded">
                                    <Button
                                        href="/pages/loanapplication/loanhistory"
                                        onClick={handleOpen}
                                        sx={{ backgroundColor: 'white', color: 'black' }}
                                    >
                                        <Typography variant="subtitle1" sx={{ fontSize: 15, fontWeight: 'bold' }}>
...
export default Firebaseloanhomepage;
